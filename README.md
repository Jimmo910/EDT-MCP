...
| **Applications & Testing** | App management, database updates, launch configuration management, termination, testing | `get_applications`, `list_configurations`, `create_launch_config`, `delete_launch_config`, `update_database`, `debug_launch`, `terminate_launch`, `run_yaxunit_tests` |
...
**68 tools**, grouped by toolset. Full per-tool pages under [docs/tools/](docs/tools/).
