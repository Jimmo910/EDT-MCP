 ...
 * RESUME/TERMINATE debug events (defect C-3).
 * <p>
...
public class DebugSessionRegistryTest
{
    ...
    // === purge-by-event-source: minted-key snapshots must die on real events (C-3) ===
    ...
    // === thread → applicationId mapping (canonical key for step/resume, C-2) ===
