 ...
 * (D5c/D7b, Bitrix 20074 + 20092) — moved here alongside the helpers, which moved
...
public class LaunchLifecycleUtilsSessionTest
{
    ...
    {
        // THE PRE-D7B SERVER CASE (Bitrix 20074): a DEBUG launch whose only target is a
    ...
    {
        // THE D7B SERVER CASE (Bitrix 20074): a debug-mode standalone server target
    ...
    {
        // THE PRE-D7B SERVER CASE via findActiveTarget: a thread-less standalone-server
    ...
    {
        // THE D7B SERVER CASE via findActiveTarget (Bitrix 20074): a debug-mode
    ...
    public void testDecideRunModeLaunchIsSessionWithNoTarget()
    {
        ...
        // running client — the A12/A13 guard. Returned as a session with a null target
    ...
    {
        // THE D7B SERVER CASE via findActiveLaunch: a DEBUG launch whose only target's
