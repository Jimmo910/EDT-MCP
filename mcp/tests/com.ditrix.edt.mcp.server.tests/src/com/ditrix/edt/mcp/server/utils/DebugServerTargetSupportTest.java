 ...
 * {@code debug_yaxunit_tests}) as standard Eclipse debug-model elements.
 *
 ...
 * {@code null}. The live suspend/resume/step path needs a real running 1C server
 * session and is verified E2E.
 */
