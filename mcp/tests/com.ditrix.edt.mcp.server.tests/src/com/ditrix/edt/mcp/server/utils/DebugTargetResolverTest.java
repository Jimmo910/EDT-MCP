 ...
 *
 * <p>Only the pure parts are exercised here: id-form classification (which prefix
 * maps to which {@link DebugTargetResolver.IdForm}) and null/empty-safety. The
 * actual target resolution needs a live debug session (no
